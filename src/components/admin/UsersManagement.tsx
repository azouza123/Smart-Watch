...
export function UsersManagement() {
  ...
  const users = [
    { id: 1, name: 'Admin Principal', email: 'admin@smartwater.com', role: 'admin', status: 'active', lastLogin: '2025-10-31 09:30' },
    { id: 2, name: 'Gestionnaire Campus A', email: 'manager.a@smartwater.com', role: 'manager', status: 'active', lastLogin: '2025-10-31 08:45' },
    { id: 3, name: 'Gestionnaire Campus B', email: 'manager.b@smartwater.com', role: 'manager', status: 'active', lastLogin: '2025-10-30 17:20' },
    { id: 4, name: 'Technicien Martin', email: 'tech.martin@smartwater.com', role: 'technician', status: 'active', lastLogin: '2025-10-31 07:15' },
    { id: 5, name: 'Technicien Dupont', email: 'tech.dupont@smartwater.com', role: 'technician', status: 'active', lastLogin: '2025-10-30 16:00' },
    { id: 6, name: 'Résident A101', email: 'resident.a101@example.com', role: 'occupant', status: 'active', lastLogin: '2025-10-31 10:00' },
    { id: 7, name: 'Résident A102', email: 'resident.a102@example.com', role: 'occupant', status: 'active', lastLogin: '2025-10-30 19:30' },
    { id: 8, name: 'Résident B201', email: 'resident.b201@example.com', role: 'occupant', status: 'inactive', lastLogin: '2025-10-15 14:20' },
  ];
